...
final singleConversationProvider = FutureProvider.autoDispose
    .family<ConversationModel?, String>((ref, conversationId) async {
      return ref.read(chatServiceProvider).fetchConversation(conversationId);
    });

/// Real-time stream of all conversations for [userId].
final conversationsProvider = StreamProvider.autoDispose
    .family<List<ConversationModel>, String>(
      (ref, userId) =>
...
final messagesProvider = StreamProvider.autoDispose
    .family<List<MessageModel>, String>(
      (ref, conversationId) =>
...
final unreadCountProvider = StreamProvider.autoDispose.family<int, String>(
  (ref, userId) => ref.watch(chatServiceProvider).watchUnreadCount(userId),
);
